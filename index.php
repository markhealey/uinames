...
<body class="no-js">
	...
	<div id="help">
		...
		<p class="tip-5">Contribute through <a href="https://github.com/markhealey/uinames" target="_blank">Github</a>! 👋</p>
	...
	<div id="info" class="popover clearfix">
		...
		<div id="info-panel" style="display: block;">
			...
			<h2>Contribute</h2>
			<p>Contribute to the project through <a href="https://github.com/markhealey/uinames" target="_blank">Github</a>! This collection of names would not have been as complete without these wonderful people:</p>
			<p class="clearfix">
				<?php
	...
	<div id="region" class="popover clearfix">
		...
		<ul id="regionList" role="listbox">
			...
			<span class="contribute" style="display: none;">
				<a href="https://github.com/markhealey/uinames" target="_blank" class="clearfix">
